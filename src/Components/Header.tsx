...
export const Header = () => {
  return (
    <header className="fixed z-50 flex w-full items-center justify-between px-6 py-4 mix-blend-difference invert">
      <a href="/">
      ...
      <div className="flex gap-6 items-center">
        ...
        <FaBars size={24} className="flex lg:hidden text-neutral-500" />
      </div>
    </header>
  );
};
